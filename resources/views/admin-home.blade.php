        ...
        <li>
            <div class="post-title">
                ...
                <div class="sub-title">
                    ...
                    <button class="control-button" ><img src="{{asset('images/edit.png')}}" alt="edit"></button>
                    <button class="control-button" ><img src="{{asset('images/delete.png')}}" alt="excluir"></button>
                </div>
            </div>
            <br />
